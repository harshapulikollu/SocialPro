package apps.shark.socialpro.WebView;
...
public class SocialWebView extends WebView implements NestedScrollingChild {
    ...
    public SocialWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SocialWebView(Context context, AttributeSet attrs, int defStyleAttr) {
