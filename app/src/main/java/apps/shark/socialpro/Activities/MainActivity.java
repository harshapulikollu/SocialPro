...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mPreferences.getBoolean("nav_top_stories", false)) {
            mNavigationView.getMenu().findItem(R.id.nav_top_stories).setVisible(true);
        }
        if (!mPreferences.getBoolean("nav_friendreq", false)) {
            mNavigationView.getMenu().findItem(R.id.nav_friendreq).setVisible(true);
        }
        ...
        mWebView.setOnScrollChangedCallback(new SocialWebView.OnScrollChangedCallback() {
            @Override
